...
namespace Games.Golfinity
{
	public class TintScript : MonoBehaviour
	{
		...
		public void UpdateTint ()
	    {
	        ...
	        if (typeOfSprite == Type.Terrain)
	        {
	            selfColor = Game.instance.level.terrainColor;
			}
			else if (typeOfSprite == Type.Sky)
			{
				selfColor = Game.instance.level.skyColor;
			}
			else if (typeOfSprite == Type.Mud)
			{
				selfColor = Game.instance.level.mudColor;
			}
