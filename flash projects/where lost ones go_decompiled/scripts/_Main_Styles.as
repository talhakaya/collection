package
{
   ...
   public class _Main_Styles
   {
      ...
      private static var _embed_css_Assets_swf__166750607_mx_skins_cursor_BusyCursor_886471495:Class = _class_embed_css_Assets_swf__166750607_mx_skins_cursor_BusyCursor_886471495;
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         if(style.defaultFactory == null)
         {
            style.defaultFactory = function():void
            {
               ...
               this.busyCursorBackground = _embed_css_Assets_swf__166750607_mx_skins_cursor_BusyCursor_886471495;
            };
         }
         if(mergedStyle != null && (Boolean(mergedStyle.defaultFactory == null) || Boolean(ObjectUtil.compare(new style.defaultFactory(),new mergedStyle.defaultFactory()))))
         {
